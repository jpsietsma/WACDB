...
public partial class AG_WACAG_AgPageContents : WACContainer, IWACContainer, IWACIndependentControl
{
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            sr.ServiceFor = WACAG_FarmBusinessForm;
    ...
    protected void WACAG_FarmBusinessForm_ContentStateChanged(object sender, WAC_Event.UserControlResultEventArgs e)
    {
